              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
					$stmt = $conn->prepare("SELECT *, sales.id AS salesid FROM sales LEFT JOIN users ON users.id=sales.user_id ORDER BY sales_day DESC");
                      $stmt->execute();
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$row['recipient_fname'].' '.$row['recipient_lname']."</td>
                            <td>".$row['pay_id']."</td>
                            <td>Kshs. ".number_format($total, 2)."</td>
                            <td><button type='button' class='btn btn-info btn-sm btn-flat transact' data-id='".$row['sales_id']."'><i class='fa fa-search'></i> View</button></td>
                          </tr>
                        ";
                      }
                    }
