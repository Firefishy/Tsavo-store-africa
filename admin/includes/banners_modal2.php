    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="banners_delete.php">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="banners_edit.php">
				...
				<label for="edit_supplier" class="col-sm-1 control-label">Supplier</label>
                ...
                <div class="form-group">
				  ...
				  <label for="edit_price" class="col-sm-1 control-label">Was</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="edit_was" name="was">
                  </div>
                </div>
                <p><b>Description</b></p>
                <div class="form-group">
