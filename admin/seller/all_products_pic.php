    ...
    ?>
                ...
                <div class="row">
                    <div class="col-12">
                         <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Update my product photo.</h5>
                                <div class="table-responsive">
							       ...
							       echo '
									...
									<tr>
                                                ...
                                                <td>
												<form method="post" action="products_update_pic.php">
	                                            <input type="hidden" name="id" value="'.$row['id'].'" />
	                                            <button class="btn btn-outline-success" type="submit" name="pic_update">
												Update Photo
												</button>
												</form>
												</td>
