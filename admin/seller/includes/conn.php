<?php
//For filter
$connect = new PDO("mysql:host=localhost;dbname=tsavoo", "root", "");

//For Followers
$cone = mysqli_connect("localhost","root","","tsavoo");
if (!$cone) {
	die("Connection failed: " . mysqli_connect_error());
}
//Others general
class Database{
    private $server = "mysql:host=localhost;dbname=tsavoo";
	private $username = "root";
	private $password = "";
	private $options  = array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC,);
	private $host  = 'localhost';
    private $user  = 'root';
    private $database  = "tsavoo";
	...
	public function getItemRatingLimit($itemId){
		$sqlQuery = "
			SELECT r.ratingId, r.itemId, r.userId, u.lastname, u.photo, u.email, r.ratingNumber, r.title, r.comments, r.created, r.modified
