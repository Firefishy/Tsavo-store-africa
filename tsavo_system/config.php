<?php
	...
	$dbPassword = '';
	$dbDatabase = 'tsavoo';
	$appURI = 'tsavoo/tsavo_system';
	$host = 'localhost';

	$adminConfig = [
		'adminUsername' => "warorua_alex",
		'adminPassword' => "\$2y\$10\$lI/x8vM3ICQx395fajDuT.epd5v8aNGKlZekpSO9oV8YwyeZDZKce",
