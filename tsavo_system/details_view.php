...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsFilters = [
		"`details`.`id`" => "ID",
		"`details`.`payment`" => "Payment",
		"`details`.`supp_conf`" => "Supp conf",
		"`details`.`reference_number`" => "Reference number",
		"`details`.`product_name`" => "Product name",
		"`details`.`supp_name`" => "Supp name",
	];
	...
	$x->ColCaption = ['Payment', 'Supp conf', 'Reference number', 'Product name', 'Supp name', ];
	$x->ColFieldName = ['payment', 'supp_conf', 'reference_number', 'product_name', 'supp_name', ];
