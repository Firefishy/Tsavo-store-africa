...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->RedirectAfterInsert = 'category_view.php?SelectedID=#ID#';
	$x->TableTitle = 'Category';
	$x->TableIcon = 'resources/table_icons/photos.png';
	$x->PrimaryKey = '`category`.`id`';

	$x->ColWidth = [150, 150, ];
	$x->ColCaption = ['Category name', 'Category banner', ];
	$x->ColFieldName = ['name', 'cat_ban', ];
	$x->ColNumber  = [2, 3, ];
