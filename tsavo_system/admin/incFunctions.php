		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'system_setting' => array(
					'Caption' => 'System_setting',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/table.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'supplier' => array(
				...
				'category' => array(
					'Caption' => 'Category',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/photos.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
		);
...
########################################################################
	...
	function get_table_fields($tn = null) {
		...
		if($schema === null) {
			...
			$schema = [
				'system_setting' => [
					'flash_sale' => ['appgini' => "VARCHAR(40) NULL"],
					'date' => ['appgini' => "DATE NULL"],
					'just_sold' => ['appgini' => "VARCHAR(40) NULL"],
					'js_date' => ['appgini' => "DATE NULL"],
					'recommended' => ['appgini' => "VARCHAR(40) NULL"],
					'r_date' => ['appgini' => "DATE NULL"],
					'latest_product' => ['appgini' => "VARCHAR(40) NULL"],
					'lp_date' => ['appgini' => "DATE NULL"],
					'prods_1' => ['appgini' => "VARCHAR(200) NULL"],
					'p1_date' => ['appgini' => "DATE NULL"],
					'id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'prods_2' => ['appgini' => "VARCHAR(40) NULL"],
					'p2_date' => ['appgini' => "DATE NULL"],
					'prods_3' => ['appgini' => "VARCHAR(40) NULL"],
					'p3_date' => ['appgini' => "DATE NULL"],
					'location' => ['appgini' => "VARCHAR(100) NULL"],
					'phone' => ['appgini' => "VARCHAR(40) NULL"],
					'email' => ['appgini' => "VARCHAR(80) NULL"],
					'system_bg' => ['appgini' => "TEXT NULL"],
					'hidder' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'unhidder' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'new_script' => ['appgini' => "TEXT NULL"],
					'new_script2' => ['appgini' => "TEXT NULL"],
					'new_script3' => ['appgini' => "TEXT NULL"],
					'new_script4' => ['appgini' => "TEXT NULL"],
					'new_script5' => ['appgini' => "TEXT NULL"],
					'new_script6' => ['appgini' => "TEXT NULL"],
					'new_script7' => ['appgini' => "TEXT NULL"],
					'new_script8' => ['appgini' => "TEXT NULL"],
				],
				'supplier' => [
				...
				'products' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'promote_class' => ['appgini' => "VARCHAR(40) NULL"],
					'promote_code' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'details' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'payment' => ['appgini' => "VARCHAR(40) NULL DEFAULT 'Not Paid'"],
					'supp_conf' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'category' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'name' => ['appgini' => "VARCHAR(40) NULL"],
					'cat_ban' => ['appgini' => "VARCHAR(40) NULL"],
				],
			];
		}
