...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		"`products`.`id`" => "id",
		"`products`.`promote_class`" => "promote_class",
		"`products`.`promote_code`" => "promote_code",
		"`products`.`slug`" => "slug",
		"`products`.`name`" => "name",
	...
	$x->QueryFieldsFilters = [
		"`products`.`id`" => "ID",
		"`products`.`promote_class`" => "Promote class",
		"`products`.`promote_code`" => "Promote code",
		"`products`.`slug`" => "Product slug code",
		"`products`.`name`" => "Product Name",
		"`products`.`seller_sku`" => "Product SKU",
	];
	...
	$x->ColCaption = ['Promote class', 'Promote code', 'Product slug code', 'Product Name', 'Product SKU', ];
	$x->ColFieldName = ['promote_class', 'promote_code', 'slug', 'name', 'seller_sku', ];
