<?php
	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'board_member' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/user_suit.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'about_us' => array(
					'Caption' => 'About us',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/book_open.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'privacy_policy' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/set_security_question.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'terms_conditions' => array(
					'Caption' => 'Privacy policy',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/text_horizontalrule.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'return_policy' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/cart_error.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
		);
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		if($tableName=='staff' && $fieldName=='profile_photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='board_member' && $fieldName=='profile_photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		return FALSE;
	}
	########################################################################
		...
		if($schema === null) {
			...
			$schema = [
				'staff' => [
					...
					'profile_photo' => ['appgini' => "VARCHAR(40) NULL"],
					'first_name' => ['appgini' => "VARCHAR(40) NULL"],
					'last_name' => ['appgini' => "VARCHAR(40) NULL"],
					'position' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'about_us' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'main_head' => ['appgini' => "VARCHAR(40) NULL"],
					'main_head_content' => ['appgini' => "TEXT NULL"],
					'section_2' => ['appgini' => "VARCHAR(40) NULL"],
					'a_head' => ['appgini' => "VARCHAR(40) NULL"],
					'a_subhead' => ['appgini' => "VARCHAR(40) NULL"],
					'a_content' => ['appgini' => "TEXT NULL"],
					'b_head' => ['appgini' => "VARCHAR(40) NULL"],
					'b_subhead' => ['appgini' => "VARCHAR(40) NULL"],
					'b_content' => ['appgini' => "TEXT NULL"],
					'c_head' => ['appgini' => "VARCHAR(40) NULL"],
					'c_subhead' => ['appgini' => "VARCHAR(40) NULL"],
					'c_content' => ['appgini' => "TEXT NULL"],
					'section_3' => ['appgini' => "VARCHAR(40) NULL"],
					'a2_head' => ['appgini' => "VARCHAR(40) NULL"],
					'a2_content' => ['appgini' => "TEXT NULL"],
					'a2_head_1' => ['appgini' => "VARCHAR(40) NULL"],
					'a2_content_1' => ['appgini' => "TEXT NULL"],
					'a2_head_2' => ['appgini' => "VARCHAR(40) NULL"],
					'a2_content_2' => ['appgini' => "TEXT NULL"],
					'a2_head_3' => ['appgini' => "VARCHAR(40) NULL"],
					'a2_content_3' => ['appgini' => "TEXT NULL"],
					'section_4' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_mainhead' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_head' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_content' => ['appgini' => "VARCHAR(200) NULL"],
					'a3_head_1' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_content_1' => ['appgini' => "VARCHAR(200) NULL"],
					'a3_head_2' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_content_2' => ['appgini' => "VARCHAR(200) NULL"],
					'a3_head_3' => ['appgini' => "VARCHAR(40) NULL"],
					'a3_content_3' => ['appgini' => "VARCHAR(200) NULL"],
				],
				'privacy_policy' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'main_head' => ['appgini' => "VARCHAR(40) NULL"],
					'main_head_content' => ['appgini' => "TEXT NULL"],
					'sub_head1' => ['appgini' => "VARCHAR(40) NULL"],
					'head_1' => ['appgini' => "TEXT NULL"],
					'sub_head2' => ['appgini' => "VARCHAR(40) NULL"],
					'head_2' => ['appgini' => "TEXT NULL"],
					'sub_head3' => ['appgini' => "VARCHAR(40) NULL"],
					'head_3' => ['appgini' => "TEXT NULL"],
					'sub_head4' => ['appgini' => "VARCHAR(40) NULL"],
					'head_4' => ['appgini' => "TEXT NULL"],
				],
				'terms_conditions' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'main_head' => ['appgini' => "VARCHAR(40) NULL"],
