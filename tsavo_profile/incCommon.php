	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'staff' => ['Staff', '', 'resources/table_icons/user.png', 'None'],
			'board_member' => ['Board member', '', 'resources/table_icons/user_suit.png', 'None'],
			'about_us' => ['About us', '', 'resources/table_icons/book_open.png', 'None'],
			'privacy_policy' => ['Privacy policy', '', 'resources/table_icons/set_security_question.png', 'None'],
			'terms_conditions' => ['Privacy policy', '', 'resources/table_icons/text_horizontalrule.png', 'None'],
			'return_policy' => ['Return policy', '', 'resources/table_icons/cart_error.png', 'None'],
		];
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'staff' => "`staff`.`id` as 'id', `staff`.`profile_photo` as 'profile_photo', `staff`.`first_name` as 'first_name', `staff`.`last_name` as 'last_name', `staff`.`position` as 'position', `staff`.`details` as 'details'",
			'board_member' => "`board_member`.`id` as 'id', `board_member`.`profile_photo` as 'profile_photo', `board_member`.`first_name` as 'first_name', `board_member`.`last_name` as 'last_name', `board_member`.`position` as 'position', `board_member`.`details` as 'details'",
			'about_us' => "`about_us`.`id` as 'id', `about_us`.`main_head` as 'main_head', `about_us`.`main_head_content` as 'main_head_content', `about_us`.`section_2` as 'section_2', `about_us`.`a_head` as 'a_head', `about_us`.`a_subhead` as 'a_subhead', `about_us`.`a_content` as 'a_content', `about_us`.`b_head` as 'b_head', `about_us`.`b_subhead` as 'b_subhead', `about_us`.`b_content` as 'b_content', `about_us`.`c_head` as 'c_head', `about_us`.`c_subhead` as 'c_subhead', `about_us`.`c_content` as 'c_content', `about_us`.`section_3` as 'section_3', `about_us`.`a2_head` as 'a2_head', `about_us`.`a2_content` as 'a2_content', `about_us`.`a2_head_1` as 'a2_head_1', `about_us`.`a2_content_1` as 'a2_content_1', `about_us`.`a2_head_2` as 'a2_head_2', `about_us`.`a2_content_2` as 'a2_content_2', `about_us`.`a2_head_3` as 'a2_head_3', `about_us`.`a2_content_3` as 'a2_content_3', `about_us`.`section_4` as 'section_4', `about_us`.`a3_mainhead` as 'a3_mainhead', `about_us`.`a3_head` as 'a3_head', `about_us`.`a3_content` as 'a3_content', `about_us`.`a3_head_1` as 'a3_head_1', `about_us`.`a3_content_1` as 'a3_content_1', `about_us`.`a3_head_2` as 'a3_head_2', `about_us`.`a3_content_2` as 'a3_content_2', `about_us`.`a3_head_3` as 'a3_head_3', `about_us`.`a3_content_3` as 'a3_content_3'",
			'privacy_policy' => "`privacy_policy`.`id` as 'id', `privacy_policy`.`main_head` as 'main_head', `privacy_policy`.`main_head_content` as 'main_head_content', `privacy_policy`.`sub_head1` as 'sub_head1', `privacy_policy`.`head_1` as 'head_1', `privacy_policy`.`sub_head2` as 'sub_head2', `privacy_policy`.`head_2` as 'head_2', `privacy_policy`.`sub_head3` as 'sub_head3', `privacy_policy`.`head_3` as 'head_3', `privacy_policy`.`sub_head4` as 'sub_head4', `privacy_policy`.`head_4` as 'head_4'",
			'terms_conditions' => "`terms_conditions`.`id` as 'id', `terms_conditions`.`main_head` as 'main_head', `terms_conditions`.`main_head_content` as 'main_head_content', `terms_conditions`.`sub_head1` as 'sub_head1', `terms_conditions`.`head_1` as 'head_1', `terms_conditions`.`sub_head2` as 'sub_head2', `terms_conditions`.`head_2` as 'head_2', `terms_conditions`.`sub_head3` as 'sub_head3', `terms_conditions`.`head_3` as 'head_3', `terms_conditions`.`sub_head4` as 'sub_head4', `terms_conditions`.`head_4` as 'head_4'",
			'return_policy' => "`return_policy`.`id` as 'id', `return_policy`.`main_head` as 'main_head', `return_policy`.`main_head_content` as 'main_head_content', `return_policy`.`sub_head1` as 'sub_head1', `return_policy`.`head_1` as 'head_1', `return_policy`.`sub_head2` as 'sub_head2', `return_policy`.`head_2` as 'head_2', `return_policy`.`sub_head3` as 'sub_head3', `return_policy`.`head_3` as 'head_3', `return_policy`.`sub_head4` as 'sub_head4', `return_policy`.`head_4` as 'head_4'",
		];
	...
	function htmlUserBar() {
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> tsavo profile</a>
			</div>
