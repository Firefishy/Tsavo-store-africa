...
<a href="TsavoCategory?category=led-lcd">
<div class="jumbotron cats">
  <img src="includes/png/009-smart-tv.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=smart-tv">
<div class="jumbotron cats">
<img src="includes/png/010-smart-tv-1.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=projector">
<div class="jumbotron cats">
<img src="includes/png/projector.png" width="100%" />

</div>
</a>
</div>
		            <h1  style="border:solid;border-color:#E200E2; margin:3px; margin-left:3px; margin-right:3px" class="page-header elegantshadow">Smart Televisions</h1>
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = '147' OR category_id = '148' ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
