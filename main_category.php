   ...
   <!-- Main content -->
	      <section class="content">
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = :catid OR category_id = :catid1 OR category_id = :catid2 OR category_id = :catid3 OR category_id = :catid4 ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
