          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Zone</label>
                <textarea name="zonee" id="" cols="30" rows="2" class="form-control"><?php echo isset($zonee) ? $zonee : '' ?></textarea>
              </div>
              <div class="col-sm-6 form-group ">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Delivery Price</label>
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Station Name</label>
