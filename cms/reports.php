...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Package Approved","Collected","Shipped","In-Transit","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt"); ?>
					...
					if(typeof resp === 'object' || Array.isArray(resp) || typeof JSON.parse(resp) === 'object'){
						...
						if(Object.keys(resp).length > 0){
							...
							Object.keys(resp).map(function(k){
								...
								tr.append('<td>'+(resp[k].product_name)+'</td>')
								tr.append('<td>'+(resp[k].recipient_fname)+'</td>')
