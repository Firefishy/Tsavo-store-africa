...
<a href="TsavoCategory?category=large-appliances">
<div class="jumbotron cats">
  <img src="includes/png/015-electronics.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=small-appliances">
<div class="jumbotron cats">
<img src="includes/png/016-blender.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=CAT1622039604">
<div class="jumbotron cats">
<img src="includes/png/017-cutlery.png" width="100%" />

</div>
</a>

</div>
		            <h1  style="border:solid;border-color:#E200E2; margin:3px; margin-left:3px; margin-right:3px" class="page-header elegantshadow">Kitchen</h1>
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = '165' OR category_id = '273' OR category_id = '259' ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
