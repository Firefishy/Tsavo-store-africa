...
<a href="TsavoCategory?category=snacks">
<div class="jumbotron cats">
  <img src="includes/png/001-snack.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=vegetables">
<div class="jumbotron cats">
<img src="includes/png/002-cabbage.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=coffee-tea-cocoa">
<div class="jumbotron cats">
<img src="includes/png/003-coffee.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=spreads">
<div class="jumbotron cats">
<img src="includes/png/004-jam.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=juice-soda">
<div class="jumbotron cats">
<img src="includes/png/005-cola.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=cooking-ingredients">
<div class="jumbotron cats">
<img src="includes/png/flour.png" width="100%" />
		            ...
		            <h1  style="border:solid;border-color:#E200E2; margin:3px; margin-left:3px; margin-right:3px" class="page-header elegantshadow">Groceries</h1>
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = '160' OR category_id = '156' OR category_id = '157' OR category_id = '158' OR category_id = '159' OR category_id = '271' ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
