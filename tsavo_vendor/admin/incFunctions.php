<?php
	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'sales' => array(
					'Caption' => 'Orders Made',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/bar-chart-icon.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'products' => array(
					'Caption' => 'Products',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Folders-Binders-Folder-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'category' => array(
					...
					'Description' => '',
					'tableIcon' => 'resources/table_icons/increase-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'supplier' => array(
					'Caption' => 'Vendor',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Users-Workers-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'users' => array(
					'Caption' => 'Users/Members',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/users-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'stock' => array(
					'Caption' => 'Stock',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Database-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'agent' => array(
					'Caption' => 'Tsavo Agent',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Users-Worker-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'male_shoes' => array(
					'Caption' => 'Male shoes',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/check-icon.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'male_pants' => array(
				...
				'branches' => array(
					'Caption' => 'Delivery Branches',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Cultures-Origami-icon.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'agent_monitor' => array(
					'Caption' => 'Agent Order monitor',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Finance-Check-Book-icon.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'coupon' => array(
					'Caption' => 'Coupons',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Ecommerce-Redeem-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'cart' => array(
					'Caption' => 'Cart',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Ecommerce-Sell-icon.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'drop_off' => array(
					'Caption' => 'Drop off Points',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Home-Holland-icon.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'how_to_vendor' => array(
					'Caption' => 'Vendor Guide',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/Receipt-3-icon.png',
					'group' => $tg[4],
					'homepageShowCount' => 0
				),
				'how_to_agent' => array(
				...
				'message' => array(
					'Caption' => 'Message',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/printer-icon.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				),
				'sales_monitor' => array(
					'Caption' => 'Sales monitor',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/bar-chart-icon.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				...
				'wishlist' => array(
					'Caption' => 'Wishlist',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/card_gift_2.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'sub_cat' => array(
					'Caption' => 'Sub cat',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/bullet_purple.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				),
				'item_rating' => array(
					'Caption' => 'Item rating',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/award_star_gold_1.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'followers' => array(
				...
				'sub_cat_2' => array(
					'Caption' => 'Sub cat 2',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/bullet_pink.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				),
		);
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				...
				'male_pants' => 'Male pants',
				'male_shirts' => 'Male shirts',
				'female_shoes' => 'Female shoes',
				'female_dresses' => 'Female dresses',
				'female_skirts' => 'Female skirts',
				'female_pants' => 'Female pants',
				'details' => 'Order Details',
				'branches' => 'Delivery Branches',
				'agent_monitor' => 'Agent Order monitor',
				'coupon' => 'Coupons',
				'cart' => 'Cart',
				'drop_off' => 'Drop off Points',
				'how_to_vendor' => 'Vendor Guide',
				'how_to_agent' => 'Agent Guide',
				'message' => 'Message',
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		if($tableName=='products' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='products' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='supplier' && $fieldName=='licence_no' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='supplier' && $fieldName=='licence_no' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='supplier' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='supplier' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='supplier' && $fieldName=='store_overview' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='supplier' && $fieldName=='store_overview' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='users' && $fieldName=='photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='users' && $fieldName=='photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='drop_off' && $fieldName=='station_photo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='drop_off' && $fieldName=='station_photo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
	...
	function initSession() {
		...
		$options = [
			'name' => 'TSAVO_POINT_OF_SALE_SYSTEM',
...
########################################################################
	...
	function get_table_fields($tn = null) {
		...
		if($schema === null) {
			...
			$schema = [
				'sales' => [
					'id' => ['appgini' => "INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'user_id' => ['appgini' => "INT(11) NULL"],
					'pay_id' => ['appgini' => "VARCHAR(50) NULL"],
					'sales_day' => ['appgini' => "DATE NULL"],
					'first_name' => ['appgini' => "INT(11) NULL"],
					'last_name' => ['appgini' => "INT(11) NULL"],
					'email' => ['appgini' => "INT(11) NULL"],
					'phone' => ['appgini' => "INT(11) NULL"],
					'address' => ['appgini' => "INT(11) NULL"],
					'zone' => ['appgini' => "INT(11) NULL"],
					'zone_fee' => ['appgini' => "INT(11) NULL DEFAULT '0.00'"],
					'generated_by' => ['appgini' => "VARCHAR(40) NULL"],
					'confirmation_id' => ['appgini' => "VARCHAR(40) NULL"],
					'approval' => ['appgini' => "VARCHAR(40) NULL DEFAULT 'Not Approved'"],
				],
				'products' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'supp_id' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'supplier' => ['appgini' => "VARCHAR(40) NULL"],
					'supp_email' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'supp_cont' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'category' => ['appgini' => "INT(11) NULL"],
					'category_id' => ['appgini' => "INT(11) NULL"],
					'ship_orig' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'slug' => ['appgini' => "VARCHAR(40) NULL"],
					'prod_qty' => ['appgini' => "INT(50) NOT NULL"],
					'barcode' => ['appgini' => "INT(100) NOT NULL"],
					'name' => ['appgini' => "VARCHAR(60) NOT NULL"],
					'brand' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'photo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'size' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'material' => ['appgini' => "VARCHAR(40) NULL"],
					'length' => ['appgini' => "INT NOT NULL"],
					'width' => ['appgini' => "INT(40) NOT NULL"],
					'height' => ['appgini' => "INT NOT NULL"],
					'weight' => ['appgini' => "INT(40) NOT NULL"],
					'date_view' => ['appgini' => "DATE NULL"],
					'counter' => ['appgini' => "INT(40) NULL DEFAULT '1'"],
					'price_1' => ['appgini' => "VARCHAR(40) NULL"],
					'was' => ['appgini' => "INT(11) NULL"],
					'price_2' => ['appgini' => "VARCHAR(40) NULL"],
					'shipping_add' => ['appgini' => "VARCHAR(40) NULL"],
					'price' => ['appgini' => "DOUBLE(1,0) NULL"],
					'p_off' => ['appgini' => "DECIMAL(10,0) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
					'more_desc' => ['appgini' => "TEXT NULL"],
					'seller_sku' => ['appgini' => "VARCHAR(40) NULL"],
					'note' => ['appgini' => "VARCHAR(40) NULL"],
					'male_shoes' => ['appgini' => "INT UNSIGNED NULL"],
					'male_shoes_id' => ['appgini' => "INT UNSIGNED NULL"],
					'male_pants' => ['appgini' => "INT UNSIGNED NULL"],
					'male_pants_id' => ['appgini' => "INT UNSIGNED NULL"],
					'male_shirts' => ['appgini' => "INT UNSIGNED NULL"],
					'male_shirts_id' => ['appgini' => "INT UNSIGNED NULL"],
					'female_shoes' => ['appgini' => "INT UNSIGNED NULL"],
					'female_shoes_id' => ['appgini' => "INT UNSIGNED NULL"],
					'female_dresses' => ['appgini' => "INT UNSIGNED NULL"],
					'female_dresses_id' => ['appgini' => "INT UNSIGNED NULL"],
					'female_skirts' => ['appgini' => "INT UNSIGNED NULL"],
					'female_skirts_id' => ['appgini' => "INT UNSIGNED NULL"],
					'female_pants' => ['appgini' => "INT UNSIGNED NULL"],
					'female_pants_id' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'category' => [
					'id' => ['appgini' => "INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'name' => ['appgini' => "VARCHAR(100) NULL"],
					'cat_name' => ['appgini' => "VARCHAR(40) NULL"],
					'sub_cat' => ['appgini' => "VARCHAR(40) NULL"],
					'code' => ['appgini' => "VARCHAR(40) NULL"],
					'cat_slug' => ['appgini' => "VARCHAR(150) NULL"],
				],
				'supplier' => [
					'supp_slug' => ['appgini' => "VARCHAR(40) NULL"],
					'name' => ['appgini' => "VARCHAR(100) NULL UNIQUE"],
					'shop_id' => ['appgini' => "VARCHAR(40) NULL"],
					'supp_name' => ['appgini' => "VARCHAR(40) NULL"],
					'supp_contact' => ['appgini' => "VARCHAR(40) NULL"],
					'id_number' => ['appgini' => "INT(8) NULL"],
					'passport' => ['appgini' => "VARCHAR(40) NULL"],
					'gender' => ['appgini' => "VARCHAR(40) NULL"],
					'identity_no' => ['appgini' => "VARCHAR(40) NULL"],
					'licence_no' => ['appgini' => "VARCHAR(40) NULL"],
					'email' => ['appgini' => "VARCHAR(200) NULL"],
					'address' => ['appgini' => "VARCHAR(40) NULL"],
					'id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'photo' => ['appgini' => "VARCHAR(70) NULL"],
					'origin_country' => ['appgini' => "VARCHAR(40) NULL"],
					'type' => ['appgini' => "INT(1) NULL DEFAULT '1'"],
					'store_overview' => ['appgini' => "VARCHAR(40) NULL"],
					'drop_off_point' => ['appgini' => "INT UNSIGNED NULL"],
					'drop_off_contact' => ['appgini' => "INT UNSIGNED NULL"],
					'created_on' => ['appgini' => "DATE NULL"],
					'bank_head' => ['appgini' => "VARCHAR(40) NULL DEFAULT 'Add Your Bank Details'"],
					'service_provider' => ['appgini' => "VARCHAR(40) NULL"],
					'sp_name' => ['appgini' => "VARCHAR(40) NULL"],
					'sp_number' => ['appgini' => "VARCHAR(40) NULL"],
					'account_name' => ['appgini' => "VARCHAR(40) NULL"],
					'account_number' => ['appgini' => "INT(25) NULL"],
					'iban_number' => ['appgini' => "INT(30) NULL"],
					'bank_name' => ['appgini' => "VARCHAR(40) NULL"],
					'bank_branch' => ['appgini' => "VARCHAR(40) NULL"],
					'bank_code' => ['appgini' => "VARCHAR(40) NULL"],
					'mode_of_transfer' => ['appgini' => "VARCHAR(40) NULL"],
					'terms_conditions' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'reg_date' => ['appgini' => "DATE NULL"],
				],
				'users' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'wallet' => ['appgini' => "VARCHAR(40) NULL"],
					'password' => ['appgini' => "VARCHAR(60) NULL"],
					'type' => ['appgini' => "INT(1) NULL"],
					'firstname' => ['appgini' => "VARCHAR(50) NULL"],
					'lastname' => ['appgini' => "VARCHAR(50) NULL"],
					'email' => ['appgini' => "VARCHAR(200) NULL"],
					'contact_info' => ['appgini' => "VARCHAR(100) NULL"],
					'address' => ['appgini' => "TEXT NULL"],
					'photo' => ['appgini' => "VARCHAR(200) NULL"],
					'status' => ['appgini' => "INT(1) NULL DEFAULT '1'"],
					'activate_code' => ['appgini' => "VARCHAR(15) NULL"],
					'reset_code' => ['appgini' => "VARCHAR(15) NULL"],
					'created_on' => ['appgini' => "DATE NULL"],
					'zone' => ['appgini' => "DECIMAL(10,2) UNSIGNED NULL"],
					'discount' => ['appgini' => "INT UNSIGNED NULL"],
					'coupon_code' => ['appgini' => "INT UNSIGNED NULL"],
					'coupon_worth' => ['appgini' => "VARCHAR(40) NULL"],
					'cost' => ['appgini' => "DECIMAL(10,2) UNSIGNED NULL DEFAULT '0.00'"],
					'coupon_id' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'stock' => [
					'company_stock_quantity' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'product_name' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'product_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'supplier' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'stock_quantity' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
				],
				'agent' => [
					'first_name' => ['appgini' => "VARCHAR(40) NULL"],
					'last_name' => ['appgini' => "VARCHAR(40) NULL"],
					'email' => ['appgini' => "VARCHAR(40) NULL"],
					'phone' => ['appgini' => "INT(20) NULL"],
					'address' => ['appgini' => "VARCHAR(100) NULL"],
					'id' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'station' => ['appgini' => "VARCHAR(40) NULL"],
					'zone' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'male_shoes' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'name' => ['appgini' => "VARCHAR(40) NULL"],
					'cat_slug' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'male_pants' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'name' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'details' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'supp_conf' => ['appgini' => "VARCHAR(40) NULL DEFAULT 'Not Seen'"],
					'supp_name' => ['appgini' => "INT UNSIGNED NULL"],
					'details' => ['appgini' => "TEXT NULL"],
					'sales_id' => ['appgini' => "INT(11) NULL"],
					'payy_id' => ['appgini' => "INT(11) NULL"],
					'reference_number' => ['appgini' => "VARCHAR(40) NULL"],
					'product_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'product_name' => ['appgini' => "VARCHAR(40) NULL"],
					'quantity' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'size' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'sales_date' => ['appgini' => "DATE NULL"],
					'user_id' => ['appgini' => "INT(11) NULL"],
					'recipient_fname' => ['appgini' => "VARCHAR(40) NULL"],
					'recipient_lname' => ['appgini' => "VARCHAR(40) NULL"],
					'recipient_contact' => ['appgini' => "VARCHAR(40) NULL"],
					'recipient_email' => ['appgini' => "VARCHAR(40) NULL"],
					'recipient_address' => ['appgini' => "VARCHAR(40) NULL"],
					'weight' => ['appgini' => "VARCHAR(40) NULL"],
					'length' => ['appgini' => "VARCHAR(40) NULL"],
					'width' => ['appgini' => "VARCHAR(40) NULL"],
					'height' => ['appgini' => "VARCHAR(40) NULL"],
					'price' => ['appgini' => "VARCHAR(40) NULL DEFAULT '0.00'"],
					'pus' => ['appgini' => "VARCHAR(40) NULL"],
					'last_edit' => ['appgini' => "VARCHAR(40) NULL"],
					'editor' => ['appgini' => "VARCHAR(40) NULL"],
					'conf_id' => ['appgini' => "INT(11) NULL"],
					'from_branch_id' => ['appgini' => "INT(10) NULL DEFAULT '1'"],
					'to_branch_id' => ['appgini' => "INT(10) NULL DEFAULT '0'"],
					'type' => ['appgini' => "INT(10) NULL DEFAULT '2'"],
					'status' => ['appgini' => "VARCHAR(40) NULL DEFAULT '0'"],
					'total_sales' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'branches' => [
					'branch_code' => ['appgini' => "VARCHAR(40) NULL"],
					'country' => ['appgini' => "VARCHAR(40) NULL"],
					'city' => ['appgini' => "VARCHAR(40) NULL"],
					'zonee' => ['appgini' => "VARCHAR(40) NULL"],
					'state' => ['appgini' => "INT NULL"],
					'price' => ['appgini' => "DECIMAL(10,2) NULL DEFAULT '0.00'"],
					'zip_code' => ['appgini' => "DECIMAL(10,2) NULL"],
					'contact' => ['appgini' => "VARCHAR(40) NULL"],
					'id' => ['appgini' => "DECIMAL(40,2) UNSIGNED NOT NULL PRIMARY KEY"],
				],
				'agent_monitor' => [
					'pay_number' => ['appgini' => "INT(11) NULL"],
					'user_id' => ['appgini' => "INT(11) NULL"],
					'sale_date' => ['appgini' => "INT(11) NULL DEFAULT '1'"],
					'user_name' => ['appgini' => "INT(11) NULL"],
					'phone' => ['appgini' => "INT(11) NULL"],
					'email' => ['appgini' => "INT(11) NULL"],
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'editors_name' => ['appgini' => "VARCHAR(40) NULL"],
					'create_time' => ['appgini' => "TIME NULL"],
				],
				'coupon' => [
					'coupon_id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'coupon_code' => ['appgini' => "VARCHAR(40) NULL"],
					'discount' => ['appgini' => "MEDIUMINT(100) NULL"],
				...
				'cart' => [
					...
					'product_name' => ['appgini' => "VARCHAR(40) NULL"],
					'price' => ['appgini' => "DECIMAL(10,2) NULL DEFAULT '0.00'"],
					'user_cont' => ['appgini' => "VARCHAR(40) NULL"],
					'user_email' => ['appgini' => "VARCHAR(40) NULL"],
					'zone_pus' => ['appgini' => "VARCHAR(40) NULL"],
					'coupon_user' => ['appgini' => "VARCHAR(40) NULL"],
					'coupon_user_worth' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'drop_off' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'point_name' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'location' => ['appgini' => "TEXT NULL"],
					'licence' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'packages_accepted' => ['appgini' => "TEXT NOT NULL"],
					'operating_licence' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'station_email' => ['appgini' => "VARCHAR(40) NULL"],
					'station_photo' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'station_contact' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'agent_incharge' => ['appgini' => "VARCHAR(40) NOT NULL"],
					'agent_id' => ['appgini' => "VARCHAR(40) NULL"],
					'station_reg_date' => ['appgini' => "DATE NULL"],
				],
				'how_to_vendor' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'how_to_1' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_2' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_3' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_4' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_5' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_6' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_7' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_8' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_9' => ['appgini' => "VARCHAR(40) NULL"],
					'how_to_10' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'how_to_agent' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'how_to_1' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'message' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'user_id' => ['appgini' => "INT UNSIGNED NULL"],
					'user_name' => ['appgini' => "INT UNSIGNED NULL"],
					'product' => ['appgini' => "VARCHAR(40) NULL"],
					'message' => ['appgini' => "TEXT NULL"],
				],
				'sales_monitor' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'product_id' => ['appgini' => "INT UNSIGNED NULL"],
					'product_name' => ['appgini' => "INT UNSIGNED NULL"],
					'total_sale' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'wishlist' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'user_id' => ['appgini' => "INT UNSIGNED NULL"],
					'w_fname' => ['appgini' => "INT UNSIGNED NULL"],
					'w_lname' => ['appgini' => "INT UNSIGNED NULL"],
					'w_email' => ['appgini' => "INT UNSIGNED NULL"],
					'w_pnumber' => ['appgini' => "INT UNSIGNED NULL"],
					'product_id' => ['appgini' => "INT UNSIGNED NULL"],
					'w_product' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'sub_cat' => [
					'sub_category' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
				],
				'item_rating' => [
					'ratingId' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'itemId' => ['appgini' => "INT UNSIGNED NULL"],
					'userId' => ['appgini' => "INT UNSIGNED NULL"],
					'rater_name' => ['appgini' => "INT UNSIGNED NULL"],
					'ratingNumber' => ['appgini' => "VARCHAR(40) NULL"],
					'title' => ['appgini' => "VARCHAR(40) NULL"],
					'comments' => ['appgini' => "TEXT NULL"],
					'created' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'followers' => [
					'likeid' => ['appgini' => "INT NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'userid' => ['appgini' => "INT UNSIGNED NULL"],
					'f_fname' => ['appgini' => "INT UNSIGNED NULL"],
					'vendorid' => ['appgini' => "VARCHAR(40) NULL"],
					'follow_date' => ['appgini' => "DATE NULL"],
				],
				'sub_cat_2' => [
					'code' => ['appgini' => "VARCHAR(40) NOT NULL PRIMARY KEY"],
					'cat_name' => ['appgini' => "VARCHAR(40) NULL"],
				],
			];
		}
	...
	*/
	...
	function calculated_fields() {
		...
		return array(
			...
			'products' => array(
				'price_2' => 'SELECT weight + 10 FROM products WHERE id=\'%ID%\'',
				'shipping_add' => 'SELECT weight * 10 FROM products WHERE id=\'%ID%\'',
				'price' => 'SELECT price_1 + price_2 + shipping_add FROM products WHERE id=\'%ID%\'',
				'p_off' => 'SELECT ((was - price) * 100) / was FROM products WHERE id=\'%ID%\'',
			),
			'category' => array(
			),
			'supplier' => array(
			...
			'details' => array(
				'total_sales' => 'SELECT SUM(price) FROM details;',
			),
			'branches' => array(
				'zip_code' => 'SELECT state * price FROM branches WHERE id=\'%ID%\'',
			),
			'agent_monitor' => array(
			),
			'coupon' => array(
			...
			'sales_monitor' => array(
				'total_sale' => 'SELECT 
	SUM(quantityOrdered * priceEach)  total_salel
FROM
	details
WHERE
	id = 10100;',
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			'sales' => [
				'user_id' => 'SELECT `users`.`id`, `users`.`id` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'first_name' => 'SELECT `users`.`id`, `users`.`firstname` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'last_name' => 'SELECT `users`.`id`, `users`.`lastname` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'email' => 'SELECT `users`.`id`, `users`.`email` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'phone' => 'SELECT `users`.`id`, `users`.`contact_info` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'address' => 'SELECT `users`.`id`, `users`.`address` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'zone' => 'SELECT `users`.`id`, `users`.`zone` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'zone_fee' => 'SELECT `users`.`id`, `users`.`cost` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
			],
			'products' => [
				'category' => 'SELECT `category`.`id`, `category`.`name` FROM `category` LEFT JOIN `sub_cat_2` as sub_cat_21 ON `sub_cat_21`.`code`=`category`.`cat_name` LEFT JOIN `sub_cat` as sub_cat1 ON `sub_cat1`.`sub_category`=`category`.`sub_cat` ORDER BY 2',
				'category_id' => 'SELECT `category`.`id`, `category`.`id` FROM `category` LEFT JOIN `sub_cat_2` as sub_cat_21 ON `sub_cat_21`.`code`=`category`.`cat_name` LEFT JOIN `sub_cat` as sub_cat1 ON `sub_cat1`.`sub_category`=`category`.`sub_cat` ORDER BY 2',
				'male_shoes' => 'SELECT `male_shoes`.`id`, `male_shoes`.`name` FROM `male_shoes` ORDER BY 2',
				'male_shoes_id' => 'SELECT `male_shoes`.`id`, `male_shoes`.`id` FROM `male_shoes` ORDER BY 2',
				'male_pants' => 'SELECT `male_pants`.`id`, `male_pants`.`name` FROM `male_pants` ORDER BY 2',
				'male_pants_id' => 'SELECT `male_pants`.`id`, `male_pants`.`id` FROM `male_pants` ORDER BY 2',
				'male_shirts' => 'SELECT `male_shirts`.`id`, `male_shirts`.`name` FROM `male_shirts` ORDER BY 2',
				'male_shirts_id' => 'SELECT `male_shirts`.`id`, `male_shirts`.`id` FROM `male_shirts` ORDER BY 2',
				'female_shoes' => 'SELECT `female_shoes`.`id`, `female_shoes`.`name` FROM `female_shoes` ORDER BY 2',
				'female_shoes_id' => 'SELECT `female_shoes`.`id`, `female_shoes`.`id` FROM `female_shoes` ORDER BY 2',
				'female_dresses' => 'SELECT `female_dresses`.`id`, `female_dresses`.`name` FROM `female_dresses` ORDER BY 2',
				'female_dresses_id' => 'SELECT `female_dresses`.`id`, `female_dresses`.`id` FROM `female_dresses` ORDER BY 2',
				'female_skirts' => 'SELECT `female_skirts`.`id`, `female_skirts`.`name` FROM `female_skirts` ORDER BY 2',
				'female_skirts_id' => 'SELECT `female_skirts`.`id`, `female_skirts`.`id` FROM `female_skirts` ORDER BY 2',
				'female_pants' => 'SELECT `female_pants`.`id`, `female_pants`.`name` FROM `female_pants` ORDER BY 2',
				'female_pants_id' => 'SELECT `female_pants`.`id`, `female_pants`.`id` FROM `female_pants` ORDER BY 2',
			],
			'category' => [
				'cat_name' => 'SELECT `sub_cat_2`.`code`, `sub_cat_2`.`cat_name` FROM `sub_cat_2` ORDER BY 2',
				'sub_cat' => 'SELECT `sub_cat`.`sub_category`, `sub_cat`.`sub_category` FROM `sub_cat` ORDER BY 2',
				'code' => 'SELECT `sub_cat_2`.`code`, `sub_cat_2`.`code` FROM `sub_cat_2` ORDER BY 2',
			],
			'supplier' => [
				'drop_off_point' => 'SELECT `drop_off`.`id`, `drop_off`.`point_name` FROM `drop_off` ORDER BY 2',
				'drop_off_contact' => 'SELECT `drop_off`.`id`, `drop_off`.`station_contact` FROM `drop_off` ORDER BY 2',
			],
			'users' => [
				'discount' => 'SELECT `coupon`.`coupon_id`, `coupon`.`coupon_code` FROM `coupon` ORDER BY 2',
				'coupon_id' => 'SELECT `coupon`.`coupon_id`, `coupon`.`coupon_id` FROM `coupon` ORDER BY 2',
			],
			'stock' => [
				'company_stock_quantity' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'product_name' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'product_id' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'supplier' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'stock_quantity' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
			],
			'agent' => [
			],
			'male_shoes' => [
			...
			'details' => [
				'supp_name' => 'SELECT `products`.`id`, IF(CHAR_LENGTH(`products`.`supplier`) || CHAR_LENGTH(`products`.`id`), CONCAT_WS(\'\', `products`.`supplier`, `products`.`id`), \'\') FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'sales_id' => 'SELECT `sales`.`id`, `sales`.`id` FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'payy_id' => 'SELECT `sales`.`id`, `sales`.`pay_id` FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'product_id' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'size' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
			],
			'branches' => [
			],
			'agent_monitor' => [
				'pay_number' => 'SELECT `sales`.`id`, `sales`.`pay_id` FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'user_id' => 'SELECT `sales`.`id`, IF(    CHAR_LENGTH(`users1`.`id`), CONCAT_WS(\'\',   `users1`.`id`), \'\') FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'sale_date' => 'SELECT `sales`.`id`, if(`sales`.`sales_day`,date_format(`sales`.`sales_day`,\'%m/%d/%Y\'),\'\') FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'user_name' => 'SELECT `sales`.`id`, IF(CHAR_LENGTH(`sales`.`first_name`) || CHAR_LENGTH(`sales`.`last_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`users1`.`firstname`), CONCAT_WS(\'\',   `users1`.`firstname`), \'\'), \'--\', IF(    CHAR_LENGTH(`users1`.`lastname`), CONCAT_WS(\'\',   `users1`.`lastname`), \'\')), \'\') FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'phone' => 'SELECT `sales`.`id`, IF(    CHAR_LENGTH(`users1`.`contact_info`), CONCAT_WS(\'\',   `users1`.`contact_info`), \'\') FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
				'email' => 'SELECT `sales`.`id`, IF(    CHAR_LENGTH(`users1`.`email`), CONCAT_WS(\'\',   `users1`.`email`), \'\') FROM `sales` LEFT JOIN `users` as users1 ON `users1`.`id`=`sales`.`user_id` ORDER BY 2',
			],
			'coupon' => [
			],
			'cart' => [
			...
			'message' => [
				'user_id' => 'SELECT `users`.`id`, `users`.`id` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'user_name' => 'SELECT `users`.`id`, IF(CHAR_LENGTH(`users`.`firstname`) || CHAR_LENGTH(`users`.`lastname`), CONCAT_WS(\'\', `users`.`firstname`, \'  |||   \', `users`.`lastname`), \'\') FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
			],
			'sales_monitor' => [
				'product_id' => 'SELECT `details`.`id`, `details`.`id` FROM `details` LEFT JOIN `sales` as sales1 ON `sales1`.`id`=`details`.`sales_id` LEFT JOIN `products` as products1 ON `products1`.`id`=`details`.`product_id` ORDER BY 2',
				'product_name' => 'SELECT `details`.`id`, `details`.`id` FROM `details` LEFT JOIN `sales` as sales1 ON `sales1`.`id`=`details`.`sales_id` LEFT JOIN `products` as products1 ON `products1`.`id`=`details`.`product_id` ORDER BY 2',
			],
			'wishlist' => [
				'user_id' => 'SELECT `users`.`id`, `users`.`id` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'w_fname' => 'SELECT `users`.`id`, `users`.`firstname` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'w_lname' => 'SELECT `users`.`id`, `users`.`lastname` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'w_email' => 'SELECT `users`.`id`, `users`.`email` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'w_pnumber' => 'SELECT `users`.`id`, `users`.`contact_info` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'product_id' => 'SELECT `products`.`id`, `products`.`id` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
				'w_product' => 'SELECT `products`.`id`, `products`.`name` FROM `products` LEFT JOIN `category` as category1 ON `category1`.`id`=`products`.`category` LEFT JOIN `male_shoes` as male_shoes1 ON `male_shoes1`.`id`=`products`.`male_shoes` LEFT JOIN `male_pants` as male_pants1 ON `male_pants1`.`id`=`products`.`male_pants` LEFT JOIN `male_shirts` as male_shirts1 ON `male_shirts1`.`id`=`products`.`male_shirts` LEFT JOIN `female_shoes` as female_shoes1 ON `female_shoes1`.`id`=`products`.`female_shoes` LEFT JOIN `female_dresses` as female_dresses1 ON `female_dresses1`.`id`=`products`.`female_dresses` LEFT JOIN `female_skirts` as female_skirts1 ON `female_skirts1`.`id`=`products`.`female_skirts` LEFT JOIN `female_pants` as female_pants1 ON `female_pants1`.`id`=`products`.`female_pants` ORDER BY 2',
			],
			'sub_cat' => [
			],
			'item_rating' => [
				'userId' => 'SELECT `users`.`id`, `users`.`id` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'rater_name' => 'SELECT `users`.`id`, IF(CHAR_LENGTH(`users`.`firstname`) || CHAR_LENGTH(`users`.`lastname`), CONCAT_WS(\'\', `users`.`firstname`, \'--\', `users`.`lastname`), \'\') FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
			],
			'followers' => [
				'userid' => 'SELECT `users`.`id`, `users`.`id` FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
				'f_fname' => 'SELECT `users`.`id`, IF(CHAR_LENGTH(`users`.`firstname`) || CHAR_LENGTH(`users`.`lastname`), CONCAT_WS(\'\', `users`.`firstname`, \'.  .\', `users`.`lastname`), \'\') FROM `users` LEFT JOIN `coupon` as coupon1 ON `coupon1`.`coupon_id`=`users`.`discount` LEFT JOIN `coupon` as coupon2 ON `coupon2`.`coupon_id`=`users`.`coupon_id` ORDER BY 2',
			],
			'sub_cat_2' => [
			],
		];
