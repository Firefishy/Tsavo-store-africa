...
$Translation = [
	...
	'username error' => 'Error: Business name already exists or is invalid. Make sure you provide a business name containing 4 to 20 valid characters.',
	...
	'member username' => 'Member business name',
	'check availability' => 'Check if this business name is available',
	'read only username' => 'The business name of the guest member is read-only.',
	'password' => 'Password',
	...
	'invalid username' => 'Invalid business name',
	...
	'unique anonymous username error' => 'The new anonymous business name is already taken by another member. Please make sure the business name provided is unique.',
	...
	'sure delete user' => "Are you sure you want to delete business '<USERNAME>'?",
	...
	'go to signup' => "Don't have a business name? <br>&nbsp; <a href=membership_signup.php>Sign up here</a>",
	...
	'signup' => 'Sign up',
	'user already exists' => "Business name '<MemberID>' already exists. Try another business name.",
	'user available' => "Business name '<MemberID>' is available and you can take it.",
	'empty user' => "Please type a business name in the box first then click 'Check availability'.",
	...
	'username empty' => 'You must provide a business name. Please go back and type a business name',
	...
	'username exists' => 'Business name already exists. Please go back and choose a different business name.',
	...
	'sign up here' => 'Business registration!',
	...
	'password reset details' => "Enter your business name or email address below. We'll then send a special link to your email. After you click on that link, you'll be asked to enter a new password.",
	...
	'password reset ready' => "An email with password reset instructions has been sent to your registered email address. Please follow the instructions in that email message.<br><br>If you don't receive this email within 5 minutes, try resetting your password again, and make sure you enter a correct business name or email address.",
	'password reset invalid' => 'Invalid business name or password. <a href=membership_passwordReset.php>Try again</a>, or go <a href=index.php>back to homepage</a>.',
	...
	'username invalid' => 'Business name <MemberID> already exists or is invalid. Make sure you provide a business name containing 4 to 20 valid characters.',
	'permalink' => 'Permalink',
	...
	'show all user records from table' => 'Show all records of this business from "<tablename>" table',
