<?php
	...
	$p = [
		...
		'supplier' => [
			'identity_no' => getUploadDir(''),
			'licence_no' => getUploadDir(''),
			'photo' => getUploadDir(''),
			'store_overview' => getUploadDir(''),
			'primary key' => 'id'
		],
		'users' => [
			'photo' => getUploadDir(''),
		...
		'drop_off' => [
			'licence' => getUploadDir(''),
			'operating_licence' => getUploadDir(''),
			'station_photo' => getUploadDir(''),
			'primary key' => 'id'
		],
	];
