...
<a href="TsavoCategory?category=smart-phones">
<div class="jumbotron cats">
  <img src="includes/png/006-smartphone.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=push-button-phone">
<div class="jumbotron cats">
<img src="includes/png/007-phone-with-buttons-keyboard.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=office-telephone">
<div class="jumbotron cats">
<img src="includes/png/008-telephone.png" width="100%" />

</div>
</a>
</div>
		            <h1  style="border:solid;border-color:#E200E2; margin:3px; margin-left:3px; margin-right:3px" class="page-header elegantshadow">Phones</h1>
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = '225' OR category_id = '226' OR category_id = '227' ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
