...
<a href="TsavoCategory?category=men-clothing">
<div class="jumbotron cats">
  <img src="includes/png/011-suit-and-tie-outfit.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=women-clothing">
<div class="jumbotron cats">
<img src="includes/png/012-women-suit.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=boy-grooming">
<div class="jumbotron cats">
<img src="includes/png/013-teenage.png" width="100%" />

</div>
</a>
<a href="TsavoCategory?category=girl-grooming">
<div class="jumbotron cats">
<img src="includes/png/014-teenage-1.png" width="100%" />

</div>
</a>
</div>
		            <h1  style="border:solid;border-color:#E200E2; margin:3px; margin-left:3px; margin-right:3px" class="page-header elegantshadow">Fashion</h1>
		   ...
		   <?php
		       			...
		       			try{
		       			 	$inc = 3;	
						    $stmt = $conn->prepare("SELECT * FROM products WHERE category_id = '233' OR category_id = '231' OR category_id = '230' OR category_id = '236' ORDER BY RAND()");
						    $stmt->execute();
						    foreach ($stmt as $row) {
